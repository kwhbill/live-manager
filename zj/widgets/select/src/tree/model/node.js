export default class Node {
    constructor({key, label, disabled, isChecked, isExpand, isLeaf, isRoot, level = 0, data}){
        this.key = key
        this.parent = null
        this.children = []
        this.label = label
    ...
    delChild(node){
        ...
        if(this.children.length != count){  // 有变化，方变更 checked
    ...
    check(value, broadcastDirection){
        ...
        this.broadcast("check", this.isChecked, broadcastDirection)
    }
